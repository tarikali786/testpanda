      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card border border-foreground/10 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-5 py-3.5 bg-foreground text-background text-sm font-medium hover:bg-foreground/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* Google G icon */}
            <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" opacity=".6" />
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          New here?{" "}
          <span className="text-foreground">Your 30-day free trial starts automatically.</span>
