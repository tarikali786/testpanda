...
export default async function DashboardPage() {
  ...
  // Fetch user data + trial from Firestore
      ...
      <main className="max-w-[1200px] mx-auto px-6 lg:px-12 py-12">
        ...
        {trialExpired && (
          <div className="bg-[#eca8d6]/10 border border-[#eca8d6]/30 p-5 mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a
              href="/#pricing"
              className="inline-flex items-center gap-2 text-sm font-medium bg-foreground text-background px-5 py-2.5 hover:bg-foreground/90 transition-colors whitespace-nowrap"
            >
        ...
        <div className="bg-card border border-foreground/10 p-6 lg:p-8 mb-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h1 className="text-2xl lg:text-3xl font-display mb-1">
            ...
            {!trialExpired && (
              <div className="lg:min-w-[280px]">
                ...
                <div className="h-1.5 bg-foreground/10 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#eca8d6] rounded-full transition-all duration-500"
                ...
                <div className="mt-4">
                  <a
                    href="/#pricing"
                    className="inline-flex items-center gap-2 text-sm font-medium border border-foreground/20 px-4 py-2 hover:border-foreground transition-colors"
                  >
